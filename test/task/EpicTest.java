...
class EpicTest {
    ...
    public void epicStatusShouldBeNewIfSubtaskIsAbsent() {
        ...
        assertEquals(StatusTask.NEW, epicStatus, "Статус не соответствует! NEW ");
    }
    ...
    public void epicStatusShouldBeDoneIfSubtaskStatusDone() {
        ...
        assertEquals(StatusTask.DONE, epicStatus, "Статус не соответствует! DONE ");
    }
    ...
    public void epicStatusShouldBeDoneIfSubtaskStatusDoneNew() {
        ...
        assertEquals(StatusTask.IN_PROGRESS, epicStatus, "Статус не соответствует! IN_PROGRESS ");
    }
